...
export class AddEmployeePage extends LitElement {
  ...
  validate() {
    ...
    if (!/^[\d\s+()-]{7,}$/.test(phoneNumber)) errors.phoneNumber = 'Invalid phone number';
  ...
  render() {
    ...
    return html`
      <form class="form-container" @submit=${this.handleSubmit} autocomplete="off">
        ...
        <div class="input-wrapper">Date of Birth
        ...
        <button type="submit" ?disabled=${this.submitting}>Add Employee</button>
      </form>
    `;
  }
}
