...
class EmployeeListTableView extends LitElement {
  ...
  constructor() {
    super();
    this.employees = useEmployeeStore.getState().employees.slice(0, 9);
            ...
            ${this.employees.map(emp => html`
              <tr>
                ...
                <td class="actions">
                  ...
                  <span title="Delete" style="cursor:pointer;display:inline-flex;align-items:center;">${deleteIcon}</span>
                </td>
              </tr>
            `)}
          </tbody>
